...
class TestItem(unittest.TestCase):
	...
	def setUp(self):
		...
		self.lamp = SwitchableItem(1043, 0x100A, Labels("lamp", "a lamp", "a small lamp"), 2, None, None, lamp_switching_info)
		self.button = SwitchableItem(1044, 0x8, Labels("button", "a button", "a red button", [". It is dark", ". It is glowing"]), 2, None, None, button_switching_info)
		self.lever = SwitchableItem(1045, 0x8, Labels("lever", "a lever", "a mysterious lever"), 2, None, None, lever_switching_info)
