...
class TestArgumentResolver(unittest.TestCase):
	...
	def test_resolve_movement_without_arg(self):
		command = Command(1, 0x40, 0x0, None, self.handler_function, None, "", [], None, None)
	...
	def test_resolve_movement_with_arg(self):
		command = Command(1, 0x40, 0x1, None, self.handler_function, None, "", [], None, None)
	...
	def test_resolve_switchable_without_arg(self):
		command = Command(1, 0x100, 0x0, None, self.handler_function, None, "verbose", [], "no", "yes")
	...
	def test_resolve_switchable_with_invalid_arg(self):
		command = Command(1, 0x100, 0x1, None, self.handler_function, None, "verbose", [], "no", "yes")
	...
	def test_resolve_argless_without_arg(self):
		command = Command(1, 0x0, 0x0, None, self.handler_function, None, "", [], None, None)
	...
	def test_resolve_args_without_arg(self):
		command = Command(1, 0x9, 0x1, None, self.handler_function, None, "take", [], None, None)
		player = Player(0, 0)
	...
	def test_resolve_args_without_arg_permissive(self):
		command = Command(1, 0x89, 0x0, None, self.handler_function, None, "", [], None, None)
	...
	def test_resolve_args_with_non_item_arg(self):
		command = Command(1, 0x9, 0x1, None, self.handler_function, None, "explain", [], None, None)
	...
	def test_resolve_args_with_item_arg_unknown(self):
		command = Command(1, 0x9, 0x3, None, self.handler_function, None, "take", [], None, None)
	...
	def test_resolve_args_with_item_arg_known_needs_inventory_only_and_player_not_carrying(self):
		command = Command(1, 0x8, 0xB, None, self.handler_function, None, "drop", [], None, None)
		player = Mock()
	...
	def test_resolve_args_with_item_arg_known_needs_location_only_and_player_is_carrying(self):
		command = Command(1, 0x8, 0x7, None, self.handler_function, None, "take", [], None, None)
		player = Mock()
	...
	def test_resolve_args_with_item_arg_known_needs_inventory_or_location_and_player_not_near(self):
		command = Command(1, 0x8, 0xF, None, self.handler_function, None, "describe", [], None, None)
		player = Mock()
	...
	def test_resolve_args_switching_command_not_switchable_item(self):
		command = Command(1, 0x808, 0xF, None, self.handler_function, None, "turn", [], None, None)
		player = Mock()
		player.has_or_is_near_item.return_value = True
