...
class Message:
	...
	ITEM_NON_USABLE_WITH_LIST_TEMPLATE_USING = (Severity.WARN, "Invalid field \"list_template_using\" found for item {0} \"{1}\". This field is only valid for usable items and will be ignored here.")
