...
class Message:
	...
	ITEM_NON_USABLE_WITH_LIST_TEMPLATE_USING_OLD = (Severity.WARN, "Invalid field \"list_template_using\" found for item {0} \"{1}\". This field is only valid for usable items and will be ignored here.")
	...
	ITEM_USABLE_NO_LIST_TEMPLATE_USING_OLD = (Severity.ERROR, "Mandatory field \"list_template_using\" not found for usable item {0} \"{1}\".")
	ITEM_WEARABLE_NO_LIST_TEMPLATE = (Severity.WARN, "No list template found for wearable item {0} \"{1}\". While not mandatory, this will lead to incomplete descriptions of this item when listed.")
