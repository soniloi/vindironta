...
class Message:
	...
	ITEM_CONTAINER_SHARED = (Severity.ERROR, "Container item {0} \"{1}\" contains multiple items. This is not supported.")
	...
	ITEM_CONTAINER_UNKNOWN = (Severity.ERROR, "Item {0} \"{1}\" specifies container with id {2}, but this does not reference a valid container.")
	...
	ITEM_NON_MOBILE_SAILABLE = (Severity.ERROR, "Item {0} \"{1}\" is marked as both non-mobile and sailable.")
	...
	ITEM_USABLE_LIQUID = (Severity.ERROR, "Usable item {0} \"{1}\" is marked as liquid.")
	...
	ITEM_WEARABLE_SAILABLE = (Severity.ERROR, "Usable item {0} \"{1}\" is marked as both wearable and sailable.")
